...
export default function QuizHeader({ user, timeSpent, onFinishRequest }: Props) {
    ...
    <header className="h-16 lg:h-24 bg-black/40 backdrop-blur-md border-b border-white/10 flex items-center justify-between px-4 lg:px-12 shrink-0 relative z-50">
      <div className="flex items-center gap-3 lg:gap-6">
        <div className="flex flex-col">
          <span className="hidden lg:block text-[10px] uppercase font-bold tracking-widest text-white/40 mb-1">Thí sinh</span>
      ...
      <div className="flex flex-col lg:absolute lg:left-1/2 lg:-translate-x-1/2 items-center gap-1 lg:gap-3 bg-white/5 px-3 lg:px-6 py-1.5 lg:py-2 rounded-xl lg:rounded-2xl border border-white/10">
        ...
        <span className="hidden lg:block text-[8px] font-bold text-white/40 uppercase tracking-widest">Thời gian đã trôi qua</span>
      </div>
      ...
      <div className="flex items-center">
        ...
        >
          <div className="flex items-center gap-2 lg:gap-3 relative z-10">
            ...
            <span className="text-[10px] lg:text-xs font-black tracking-[0.1em] lg:tracking-[0.2em] uppercase italic">NỘP BÀI</span>
          </div>
        </button>
      </div>
    </header>
